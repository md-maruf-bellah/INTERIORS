...
const services = [
  {
    ...
    description:
      "We believe in designing contextual and contemporary spaces to create a positive urban change",
    // এখানে আপনার ইমেজের পাথ দিন
    image:
      "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=200&h=200",
  },
  {
    title: "Furniture Design",
    description:
      "Crafting bespoke furniture that is functional, comfortable, and aesthetically pleasing.",
    image:
      "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&q=80&w=200&h=200",
  },
  {
    title: "Architecture & Landscape",
    description:
      "Designing landscapes to improve both human and environmental health",
    image:
      "https://images.unsplash.com/photo-1518780664697-55e3ad937233?auto=format&fit=crop&q=80&w=200&h=200",
  },
];
      ...
      <div className="max-w-[1700px] mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-gray-50 p-6 flex flex-col items-center transition-all duration-300 hover:shadow-2xl border border-gray-100 hover:-translate-y-2"
            >
              {/* Image Section */}
              <div className="w-full h-50 mb-8 overflow-hidden border-4 border-white shadow-md">
                <img
                  src={service.image}
                  alt={service.title}
