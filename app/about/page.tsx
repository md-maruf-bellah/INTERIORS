...
const AboutSection = () => {
  return (
    <section className="bg-white py-24 my-20 px-6 md:px-20 lg:px-32">
      {/* Header Section */}
      <div className="grid md:grid-cols-2 gap-16 mb-24 items-end">
        ...
        <p className="text-lg text-gray-600 leading-relaxed border-l-2 border-amber-600 pl-8">
          We are an internationally recognized interior and exterior design firm
          with expertise in residential, commercial, hospitality, retail,
        ...
        <div className="space-y-10">
          ...
          <div className="bg-gray-50 p-8 rounded-sm">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Terrified of how complex a design project can be? Don't worry! Our
              designers will guide you through:
            </p>
      ...
      <div className="mt-24 pt-16 border-t border-gray-200 grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 text-gray-600 space-y-4">
          ...
          <p>
            Interior design should be about bringing the vision of the client to
            life. Design can be both aesthetic and functional.
          </p>
        </div>
      </div>
    </section>
